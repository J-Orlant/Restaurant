...
@section('content')
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        ...
                        <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> Waiter
                        </span>
                        <span class="mr-2">
                            <i class="fas fa-circle text-info"></i> Cashier
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow">
                <div class="card-header">
                    <div class="d-sm-flex align-items-center justify-content-between">
                        Laporan
                        <a href="{{ route('cetakLaporan', (Request()->has('d') ? Request()->d : $waktu)) }}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                ...
                                @if (count($laporan) == 0)
                                    ...
                                    @foreach ($laporan as $key => $data)
                                        <tr>
                                            ...
                                            <td class="text">{{ $data['nama_menu'] }}</td>
                                            <td class="text">{{ $data['jumlah'] }}</td>
                                            <td class="text">Rp.{{ number_format($data['harga']) }}</td>
                                            <td class="text">Rp.{{ number_format($data['jumlah'] * $data['harga']) }}</td>
                                        </tr>
                                    @endforeach
                                    <tr>
    ...
    <script>
        ...
        type: 'doughnut',
        data: {
            labels: ["Admin", "Waiters", "Cashier"],
            datasets: [{
            data: [{{ $admin }}, {{ $waiters }}, {{ $cashier }}],
